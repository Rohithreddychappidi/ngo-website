        ...
        <div className="container contact-grid">
          ...
          <div className="contact-info">
            ...
            <p className="contact-intro">
              Whether you want to donate, volunteer, collaborate, or just learn more — we're always happy to hear from you.
            </p>
            ...
            <div className="contact-details">
              ...
              <div className="contact-detail-item">
                ...
                <div>
                  ...
                  <span>19-27-25/1, Gandhi Nagar, VUDA Colony,<br />Pedagantyada, Visakhapatnam - 530044</span>
                </div>
              </div>
            </div>
            ...
            <div className="contact-socials">
              ...
              <div className="social-row">
                <a href="https://www.instagram.com/aneesha_joyp" target="_blank" rel="noreferrer" className="social-link instagram">
                  <InstagramIcon size={18} /> Instagram
                </a>
                <a href="https://www.facebook.com/share/1CqAnysw7Z/" target="_blank" rel="noreferrer" className="social-link facebook">
                  <FacebookIcon size={18} /> Facebook
                </a>
                <a href="https://youtube.com/@aneeshajoyp" target="_blank" rel="noreferrer" className="social-link youtube">
            ...
            <div className="map-embed">
              <iframe
                title="Location Map"
                src="https://maps.google.com/maps?q=Pedagantyada+Visakhapatnam&output=embed"
                width="100%"
                height="200"
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="contact-form">
                ...
                <div className="form-field full">
                  <label>Message *</label>
                  <textarea name="message" value={form.message} onChange={handleChange} rows={5} placeholder="Write your message..." required />
                </div>
